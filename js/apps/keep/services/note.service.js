...
function changeColor(noteId, color) {
    const note = gNotes.find(note.id === noteId)
        ...
        notes = [
            ...
            },
            {
               ...
               info: {
                   ...
                   todos:[{ id: utilService.makeId(), txt: 'Buy a ticket to Japan', doneAt: Date.now() },
            ...
            },
            {
                ...
                info: {
                    ...
                    source: 'https://www.lyricsondemand.com/tvthemes/spidermanlyrics.html!',
                    todos:[]
                }
            },
            {
               ...
               info: {
                   ...
                   todos:[{ id: utilService.makeId(), txt: 'Travel to Africa', doneAt: Date.now() },
                   { id: utilService.makeId(), txt: 'Stay at home all day', doneAt: null },
                   {id: utilService.makeId(), txt: 'Binge Brooklyn 99 (again)', doneAt: null }]
               },
